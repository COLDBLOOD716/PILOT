...
model_path = os.path.join(MODEL_DIR, f"KNN_{PHASE}.pkl")
le_path = os.path.join(MODEL_DIR, f"KNN_label_encoders_{PHASE}.pkl")
feat_path = os.path.join(MODEL_DIR, f"KNN_feature_list_{PHASE}.pkl")
scaler_path = os.path.join(MODEL_DIR, f"KNN_{PHASE}_scaler.pkl")
...
print("\n===== External Validation (Intraoperative - KNN) =====")
