...
model_path = os.path.join(MODEL_DIR, f"L1log_{PHASE}.pkl")
le_path = os.path.join(MODEL_DIR, f"L1log_label_encoders_{PHASE}.pkl")
feat_path = os.path.join(MODEL_DIR, f"L1log_feature_list_{PHASE}.pkl")
scaler_path = os.path.join(MODEL_DIR, f"L1log_{PHASE}_scaler.pkl")
...
print("\n===== External Validation (Intraoperative - L1 Logistic Regression) =====")
